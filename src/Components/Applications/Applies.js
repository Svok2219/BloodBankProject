...
<div class="modal-content ModalReciver px-md-5  overflow-hidden"  >
          <div class=" d-md-flex justify-content-center align-items-center ">
          <div class="col-12 col-md-4 text-center align-items-center    ">
          <i class="far fa-user-circle pt-3 pt-md-0" style={{color:"#EF4848",fontSize:"200px"}}></i>
           </div>
          ...
          <div  class="d-flex text-center NM pl-1"><i class="fa fa-map-marker-alt pr-1" style={{color:"#EF4848"}} aria-hidden="true"></i>
           <div class="vr px-1 text-center"></div><span class="overflow-auto"> Amborkhana , thaki1 ,5taka</span></div>
           <hr/>
           <div class="d-flex text-center NM pl-1"><i class="fas fa-phone-alt pr-1" style={{color:"#EF4848"}}></i>
           <div class="vr px-1 text-center"></div><span class="overflow-auto"> +8801791310785</span></div>
          <hr/>
          <div  class="d-flex text-center NM pl-1 "> 
                
          <i class="fas fa-mug-hot pr-1" style={{color:"#EF4848",fontSize:"34px"}}></i>
